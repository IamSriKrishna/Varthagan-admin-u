...
export const PurchaseOrderBillingSection: React.FC<PurchaseOrderBillingProps> = ({
  formik,
}) => {
  const { taxes } = useTax();
            ...
            <Grid container spacing={3}>
              <Grid size={{ xs: 12 }} component="div">
                <TextField
                  ...
                  label="Notes"
                  name="notes"
                  placeholder="Add any additional notes regarding this purchase order..."
                  multiline
                  rows={3}
...
export default PurchaseOrderBillingSection;
